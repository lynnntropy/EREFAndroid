...
class EboardResultsAdapter(internal var context: Context, internal var objects: List<EboardResultsItem>) :
        ArrayAdapter<EboardResultsItem>(context, -1, objects)
{
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View
    {
        ...
        val rowView = layoutInflater.inflate(R.layout.row_result, parent, false)
        ...
        val filePath = myDirectory.absolutePath + "/" + currentItem.dateTime
        ...
        val body = rowView.findViewById(R.id.body) as HtmlTextView
